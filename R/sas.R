...
#' @examples
#' \dontrun{
#' rmacro(system.file('testfiles', 'onemacro.sas', package = 'rawr2'),
#'        args = 'arg1 = 1, arg2 = 2',
...
#' 
#' path <- system.file('testfiles', package = 'rawr2')
...
#' @examples
#' \dontrun{
#' p <- system.file('testfiles', package = 'rawr2')
...
#' @examples
#' \dontrun{
#' source_sas(system.file('testfiles', 'onemacro.sas', package = 'rawr2'))
#' 
